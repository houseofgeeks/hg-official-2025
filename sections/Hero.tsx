  ...
  return (
    <section className="flex flex-col items-center justify-center pt-17 gap-6">
        ...
        <div className='sm:flex-row flex items-center justify-between sm:gap-10 flex-col gap-5'>
            <Button text='Join The Community →' classname='text-lg text-white border-none border-2 font-montserrat font-semibold rounded-lg px-5 py-3 bg-themecolor hover:text-black'>
            </Button>
            <Button text='Explore Domains' classname='text-lg text-white border-2 border-themecolor font-montserrat font-semibold rounded-lg px-5 py-3 hover:text-themecolor transition-all duration-300 '>
            </Button>
        </div>
    </section>
  )
